...
from smartmendr.ensemble_learner.models import Candidate, TemporarySpan, Sentence
...
class CandidateExtractor(UDFRunner):
    ...
    :param candidate_class: The type of relation to extract, defined using
                            :func:`smartmendr.ensemble_learner.models.candidate_subclass <smartmendr.ensemble_learner.models.candidate.candidate_subclass>`
    :param cspaces: one or list of :class:`CandidateSpace` objects, one for each relation argument. Defines space of
                    Contexts to consider
    :param matchers: one or list of :class:`smartmendr.ensemble_learner.matchers.Matcher` objects, one for each relation argument. Only tuples of
