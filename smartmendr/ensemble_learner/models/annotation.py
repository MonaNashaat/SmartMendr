...
from .meta import smartmendrBase
...
class GoldLabelKey(AnnotationKeyMixin, smartmendrBase):
    pass


class LabelKey(AnnotationKeyMixin, smartmendrBase):
    pass


class FeatureKey(AnnotationKeyMixin, smartmendrBase):
    pass


class PredictionKey(AnnotationKeyMixin, smartmendrBase):
    pass
...
class AnnotationMixin(object):
    ...
    .. code-block:: python
        ...
        from smartmendr.ensemble_learner.models.annotation import AnnotationMixin
        from smartmendr.ensemble_learner.models.meta import smartmendrBase

        class NewAnnotation(AnnotationMixin, smartmendrBase):
            value = Column(Float, nullable=False)


        # The entire storage schema, including NewAnnotation, can now be initialized with the following import
        import smartmendr.ensemble_learner.models
...
class GoldLabel(AnnotationMixin, smartmendrBase):
    """A separate class for labels from human annotators or other gold standards."""
    value = Column(Integer, nullable=False)


class Label(AnnotationMixin, smartmendrBase):
    """
...
class Feature(AnnotationMixin, smartmendrBase):
    """
...
class Prediction(AnnotationMixin, smartmendrBase):
    """
...
class StableLabel(smartmendrBase):
    """
